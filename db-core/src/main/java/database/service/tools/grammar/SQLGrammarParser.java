...
public class SQLGrammarParser extends Parser {
	...
	public static final int
		...
		IDENTIFIER=39, INT=40, STRING=41, FLOAT=42, WS=43;
	public static final int
		...
		RULE_dataType = 39, RULE_columnConstraint = 40;
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'*'", "','", "'='", "'AND'", "'OR'", "'<>'", "'<'", "'>'", "'<='", "'>='", 
			"'RENAME TO'", "'ADD'", "'COLUMN'", "'numeric'", "'bigint'", "'text'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, "IDENTIFIER", "INT", "STRING", "FLOAT", "WS"
		};
	}
