...
public class SQLGrammarParser extends Parser {
	...
	public static final int
		...
		T__38=39, T__39=40, T__40=41, IDENTIFIER=42, INTEGER=43, STRING=44, REAL=45, 
		BOOLEAN=46, DIGIT=47, NON_ZERO_DIGIT=48, WS=49;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'*'", "','", "'='", "'AND'", "'OR'", "'<>'", "'<'", "'>'", "'<='", "'>='", 
			"'RENAME TO'", "'ADD'", "'COLUMN'", "'INTEGER'", "'REAL'", "'STRING'", 
			"'BOOLEAN'", "'PRIMARY KEY'", "'NOT NULL'", "'UNIQUE'", "'CHECK'", "'REFERENCES'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"REAL", "BOOLEAN", "DIGIT", "NON_ZERO_DIGIT", "WS"
		};
	}
	...
	public static class LiteralContext extends ParserRuleContext {
		...
		public TerminalNode BOOLEAN() { return getToken(SQLGrammarParser.BOOLEAN, 0); }
	...
	public final ComparisonOperatorContext comparisonOperator() throws RecognitionException {
		...
		try {
			...
			setState(256);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 1044381696L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
